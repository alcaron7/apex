        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall title="Mettre à jour le mot de passe" description="Assurez-vous que votre compte est utilisant un mot de passe long et aléatoire pour rester sécurisé" />
